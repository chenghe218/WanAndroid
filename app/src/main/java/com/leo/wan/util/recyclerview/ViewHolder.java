...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setTextColor(int viewId, ColorStateList textColor) {
        TextView view = getView(viewId);
        view.setTextColor(textColor);
        return this;
    }
    ...
    public ViewHolder setCompoundDrawables(int viewId, int resourse) {
        Drawable drawable = mContext.getResources().getDrawable(resourse);
