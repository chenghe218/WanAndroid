 ...
 */
class WeChatDetailAdapter(context: Context) : BaseRecyclerAdapter<WeChatDetailBean.DatasBean>(context, R.layout.item_tree_detail) {

    override fun convert(holder: ViewHolder, dataBean: WeChatDetailBean.DatasBean, position: Int) {
